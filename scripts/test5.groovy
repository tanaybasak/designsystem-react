...
if(repo_name.equals('CSS')) {
    GITHUB_API = "https://github01.hclpnp.com/api/v3/repos/UXUIAssets/patron-css-dev/branches"
    TOTAL_PAGES = getNumberofPagesinRepo('css')
    return getBranchNamesFromPage('css');
} else if(repo_name.equals('REACT')) {
    GITHUB_API = "https://github01.hclpnp.com/api/v3/repos/UXUIAssets/patron-react-dev/branches"
    TOTAL_PAGES = getNumberofPagesinRepo('react')
    return getBranchNamesFromPage('react');
} else if(repo_name.equals('ANGULAR')) {
    GITHUB_API = "https://github01.hclpnp.com/api/v3/repos/UXUIAssets/patron-ng-dev/branches"
    TOTAL_PAGES = getNumberofPagesinRepo('ng')
    return getBranchNamesFromPage('ng');
} else {
