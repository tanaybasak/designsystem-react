...
const TextInput = ({ className, type, ...restProps }) => {
    ...
    const passwordIcon = (
        <button className="hcl-password-visibility" aria-label="Show password" onClick={() => { toggleIconVisibility(!isIconVisible) }}>
            <svg className="hcl-icon-visibility-off" width="16" height="16" viewBox="0 0 16 16" hidden={isIconVisible}>
            ...
            <svg className="hcl-icon-visibility-on" width="16" height="16" viewBox="0 0 16 11" hidden={!isIconVisible}>
