...
const Password = ({ className, disabled, ...restProps }) => {
    ...
    const passwordIcon = (
        <button type="button" disabled={disabled} className="hcl-password-visibility" aria-label="Show password" onClick={() => { toggleIconVisibility(!isIconVisible) }}>
            <Tooltip content="Show Password" direction="top" type="icon">
                <svg className="hcl-icon-visibility-off" width="16" height="16" viewBox="0 0 16 16" style={isIconVisible ? { display: 'none' } : { display: 'initial' }}>
            ...
            <Tooltip content="Hide Password" direction="top" type="icon">
                <svg className="hcl-icon-visibility-on" aria-label="Hide password" width="16" height="16" viewBox="0 0 16 11" style={!isIconVisible ? { display: 'none' } : { display: 'initial' }}>
