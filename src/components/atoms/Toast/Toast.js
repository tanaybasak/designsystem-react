...
export default function Toast({ className, type, title, subtitle, caption, iconDescription, onClose, closable, visible, ...restProps }) {
    ...
    return visible ?
        (<div
            ...
            {...restProps}
        >
            <svg className={`${prefix}-toast-icon`} focusable="false" preserveAspectRatio="xMidYMid meet"
                style={{ willChange: 'transform' }} xmlns="http://www.w3.org/2000/svg" width="20" height="20"
            ...
            <div className={`${prefix}-toast-details`}>
                ...
                {
                    caption ?
                        <p className={`${prefix}-toast-caption`}>
                            {caption}
                        </p>
                        : null
                }
