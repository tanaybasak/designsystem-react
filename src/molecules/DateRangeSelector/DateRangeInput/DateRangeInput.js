      ...
      <div className="hcl-flex-row">
        <div className="hcl-flex-col hcl-form-group">
          ...
          <input
            ...
            type="text"
            data-type="start"
            className=" hcl-dateSelector-range-input hcl-form-control hcl-dateSelector-input  mr-1"
            placeholder={format}
            autoComplete="off"
        ...
        <div className="hcl-flex-col hcl-form-group">
          ...
          <input
            ...
            data-type="end"
            className="hcl-dateSelector-input hcl-form-control hcl-dateSelector-range-input"
            placeholder={format}
            autoComplete="off"
