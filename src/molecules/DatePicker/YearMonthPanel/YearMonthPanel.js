...
const YearMonthPanel = ({
  ...
  return (
    <div className={`${prefix}-datePicker-month`}>
      <span
        className={`${prefix}-datePicker-month-prev`}
      ...
      <div className={`${prefix}-datePicker-select`}>
        <span className={`${prefix}-datePicker-curMonth`}>
          {months[currDateObj.month]}{' '}
        </span>
        <div className={`${prefix}-datePicker-year`}>
          ...
          <div className={`${prefix}-datePicker-arrows`}>
            <span
              className={`${prefix}-datePicker-up`}
              onClick={yearChangeHandler}
            />
            <span
              className={`${prefix}-datePicker-down`}
              onClick={yearChangeHandler}
            />
          </div>
        </div>
      ...
      <span
        className={`${prefix}-datePicker-month-next`}
        onClick={monthChangeHandler}
      >
        <svg width="8" height="12" viewBox="0 0 8 12" fillRule="evenodd">
