...
export default function ToolBar({ ...restProps }) {
    ...
    return (
        <section className="hcl-toolbar" aria-label="Tool Bar">
            <div className="hcl-search hcl-search-sm hcl-bg-white hcl-toolbar-search">
                <span className="hcl-search-btn" tabIndex="-1">
                    <svg focusable="false" preserveAspectRatio="xMidYMid meet" style={{'willChange': 'transform'}}
                        xmlns="http://www.w3.org/2000/svg" className="hcl-search-icon" width="16" height="16"
                ...
                <input type="search" id="goal-input3" className="hcl-search-input" placeholder="Search..." />
                <button className="hcl-search-reset" tabIndex="-1" />
            </div>
            <div className="hcl-toolbar-content">
                <button className="hcl-toolbar-action" title="download" aria-label="Download" alt="Download">
                    <svg className="hcl-toolbar-icon" fillRule="evenodd" height="16" name="download" role="img"
                ...
                <button className="hcl-toolbar-action" title="edit" aria-label="Edit" alt="Edit">
                    <svg className="hcl-toolbar-icon" fillRule="evenodd" height="16" name="edit" role="img"
                ...
                <button className="hcl-toolbar-action" title="Settings" aria-label="Settings" alt="Settings">
                    <svg className="hcl-toolbar-icon" fillRule="evenodd" height="16" name="settings" role="img"
                ...
                <button className="hcl-btn hcl-primary hcl-sm">Add new</button>
            </div>
        </section>
    );
}
